   ...
   return (
      <div>
         ...
         <h1 className="my-8 text-2xl text-accent-primary">
            {
               (!isUserAlreadyVote?.voted_cawaksis && !isUserAlreadyVote?.voted_caksis) ? 
               <>
                  Tentukan Pilihanmu 
         ...
         <div className="grid sm:grid-cols-2 grid-cols-1 gap-10">
            <Link to="/voting/caksis" className="group shadow-sm hover:shadow-lg hover:bg-thirdtiary/80 transition-all duration-500 bg-thirdtiary-light z-0 text-accent-primary p-4 rounded-3xl h-96 text-center relative overflow-hidden">
            ...
            <Link to="/voting/cawaksis" className="group shadow-sm hover:shadow-lg hover:bg-thirdtiary/80 transition-all duration-500 bg-thirdtiary-light z-0 text-accent-primary p-4 rounded-3xl h-96 text-center relative overflow-hidden">
